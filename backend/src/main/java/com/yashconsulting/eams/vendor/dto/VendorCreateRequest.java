...
@AllArgsConstructor
@Builder
@Schema(description = "Request body payload to define and create a new vendor")
public class VendorCreateRequest {

    @Schema(description = "Unique alphanumeric identifying code for the vendor", example = "VEN-MET-001", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Primary contact email address for vendor notifications", example = "contact@metalworkscorp.com")
    ...
    @Schema(description = "Vendor street or facility address details", example = "123 Industrial Way")
